...
import { deletePerson, getPeople, getPerson, postPerson, updatePerson, getStates } from "../controllers/user";
...
router.get("/states/:idUser", getStates);
